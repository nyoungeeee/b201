...
class BackofficeTeamAPITestCase(BaseBackofficeAPITestCase):
    def setUp(self):
        super().setUp()
        self.color_a = TeamColor.objects.create(color="AA0000", display_order=1)
        self.color_b = TeamColor.objects.create(color="00AA00", display_order=2)
        self.color_c = TeamColor.objects.create(color="0000AA", display_order=3)
    ...
    def test_staff_can_get_team_colors_with_availability(self):
        ...
        self.assertEqual(colors[self.color_a.id]["value"], "#AA0000")
    ...
    def test_staff_can_get_team_detail(self):
        ...
        self.assertEqual(response.data["data"]["color_value"], "#AA0000")
        self.assertEqual(
    ...
    def test_staff_can_create_team_with_current_admin_as_leader_for_zero(self):
        response = self.client.post(
            "/api/v1/admin/teams",
            {"name": "team-b", "color_id": self.color_b.id, "leader_id": 0},
            format="json",
        )
        ...
        self.assertEqual(team.color, "00AA00")
        self.assertTrue(
    ...
    def test_staff_can_update_team_name_and_color(self):
        response = self.client.patch(
            ...
            {"name": "team-renamed", "color_id": self.color_b.id},
            format="json",
        )
        ...
        self.assertEqual(self.team.color, "00AA00")
    ...
    def test_add_team_members_rejects_blocked_user(self):
        blocked_user = User.objects.create_user(kakao_id=9102, nickname="blocked")
    ...
    def test_staff_can_add_team_members(self):
        new_user = User.objects.create_user(kakao_id=9103, nickname="newbie")
    ...
    def test_change_team_leader_rejects_non_member(self):
        other_user = User.objects.create_user(kakao_id=9104, nickname="other")
