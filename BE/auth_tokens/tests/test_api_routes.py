...
class PublicAPIRouteTestCase(SimpleTestCase):
    def test_new_public_api_routes_resolve(self):
        self.assertEqual(resolve("/v1/auth/signin").url_name, "signin")
    ...
    def test_openapi_schema_uses_new_public_api_prefix(self):
        ...
        self.assertEqual(spectacular_settings["SCHEMA_PATH_PREFIX"], r"/v[0-9]")
        self.assertEqual(spectacular_settings["SERVERS"][0]["url"], "/v1")
